...
{% content-ref url="../../legacy/study/framework-and-library/jpa/generatedvalue-strategy.md" %}
[generatedvalue-strategy.md](../../legacy/study/framework-and-library/jpa/generatedvalue-strategy.md)
{% endcontent-ref %}
...
{% content-ref url="../../legacy/study/framework-and-library/jpa/entity-field-type.md" %}
[entity-field-type.md](../../legacy/study/framework-and-library/jpa/entity-field-type.md)
{% endcontent-ref %}
...
{% content-ref url="../../legacy/study/computer-science/web/rest-api/get-payload.md" %}
[get-payload.md](../../legacy/study/computer-science/web/rest-api/get-payload.md)
{% endcontent-ref %}
...
{% content-ref url="../../legacy/study/computer-science/design-pattern/builder-pattern.md" %}
[builder-pattern.md](../../legacy/study/computer-science/design-pattern/builder-pattern.md)
{% endcontent-ref %}
...
{% content-ref url="../../legacy/study/computer-science/web/rest-api/api.md" %}
[api.md](../../legacy/study/computer-science/web/rest-api/api.md)
{% endcontent-ref %}
